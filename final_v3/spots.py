...
#     cv2.imwrite("final_v3/images/leaf_only_refined.png", leaf_only_refined)
...
# cv2.imwrite("final_v3/images/pink2.png", pink_background_image)
...
# cv2.imwrite("final_v3/images/pink.png", image_with_pink_background)
...
cv2.imwrite("final_v3/images/highlighted_leaf_spots.png", cv2.cvtColor(highlighted_image, cv2.COLOR_RGB2BGR))  # Save as BGR for OpenCV
...
# Save and display the result
cv2.imwrite("final_v3/images/highlighted_blue_pixels.png", blue_mask) 
...
# Load the image
image_path = 'final_v3/images/highlighted_leaf_spots.png'  # Replace with your image path
image = cv2.imread(image_path)
...
cv2.imwrite("final_v3/images/blue_regions.png", blue_regions)
...
output_path = 'final_v3/image_array_readable.txt'
np.savetxt(output_path, image_array.reshape(-1, image_array.shape[-1]), fmt='%d', delimiter=", ", header="R, G, B")


image_with_pink_background = cv2.imread("final_v2/test/Tomato_early_blight.JPG")
...
cv2.imwrite("final_v3/images/mask_cleaned.png", mask_cleaned)
...
cv2.imwrite("final_v3/images/blue_spots.png", blue_spots)
